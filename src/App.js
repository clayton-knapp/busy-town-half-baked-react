      ...
      <div className="fight">
        ...
        <div className="monster">
          ...
          <div className="buttons">
            ...
            >Yegads! The lizard is ramping up to its final form!</button>
            {/* when you click this button, the alien's size in state should go up by one */}
            <button
              onClick={ ()=> {
                setAlienSize(alienSize - 1);
              }}
            >Oh my! The lizard chomped down on the alien!</button>
          </div>
        </div>
      </div>
